...
\begin{tikzpicture}[auto, node distance=2cm]
    ...
    \node [block, right of=model_left, fill=red!30] at (1.5,0)   (fc64_left)     {fc-64};
    \node [block, right of=fc64_left, fill=red!30] at (2.75,0)   (fc128_left)     {fc-128};



    \node [virtual] at (0,2)                       (input_right)     {};
    \node [block, right of=input_right, fill=blue!30]   at (0,2) (model_right)     {Resnet-v2};
    \node [block, right of=model_right, fill=red!30] at (1.5,2)   (fc64_right)     {fc-64};
    \node [block, right of=fc64_right, fill=red!30] at (2.75,2)   (fc128_right)     {fc-128};
    ...
    \draw [->] (fc128_right) -- node[below] {$\phi(x_A)$} (loss);
    \draw [->] (fc128_left) -- node[below] {$\phi(x_B)$} (loss);
