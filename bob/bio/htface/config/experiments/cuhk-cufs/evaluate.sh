...
./bin/evaluate_and_squash.py \
 --dev-files \
   ...
   \
   /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer-first-layer/idiap_inception_v2_gray--casia/split1/search_split1_p2s/nonorm/scores-dev \
   /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer-first-layer/idiap_inception_v2_gray--casia/split2/search_split2_p2s/nonorm/scores-dev \
   /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer-first-layer/idiap_inception_v2_gray--casia/split3/search_split3_p2s/nonorm/scores-dev \
   /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer-first-layer/idiap_inception_v2_gray--casia/split4/search_split4_p2s/nonorm/scores-dev \
   /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer-first-layer/idiap_inception_v2_gray--casia/split5/search_split5_p2s/nonorm/scores-dev \
   \
  --legends resnet siamese-resnet siamese-128-64-128-resnet siamese-resnet-first-layer \
