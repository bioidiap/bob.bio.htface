...
do
  ...
  command_string="./bin/verify.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/cuhk-cufs/$split ./src/bob.bio.htface/bob/bio/htface/config/experiments/cuhk-cufs/regular_transfer/base_setup.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/cuhk-cufs/regular_transfer/$split "
  command_string+=" --temp-directory /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer/idiap_inception_v2_gray--casia/ "
  command_string+=" --result-directory /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer/idiap_inception_v2_gray--casia/ " 
  command_string+=" -vvv "
#  command_string+=" -g demanding "
  ...
  command_string+=" --extracted-directory /idiap/temp/tpereira/HTFace/CUHK-CUFS/siamese-regular-transfer/idiap_inception_v2_gray--casia/split1/extracted "
