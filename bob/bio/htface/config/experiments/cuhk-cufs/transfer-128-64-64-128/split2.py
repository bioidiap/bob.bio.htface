...
model_filename = "/idiap/temp/tpereira/casia_webface/cuhk_cufs/siamese-transfer-128-64-64-128-idiap_inception_v2_gray--casia/split2/"
...
def build_graph(inputs, reuse=None, mode = tf.estimator.ModeKeys.TRAIN, trainable_variables=True):
    ...
    graph,_ = build_transfer_graph(graph, reuse=reuse, bottleneck_layers=[64, 64], outputs=128)
