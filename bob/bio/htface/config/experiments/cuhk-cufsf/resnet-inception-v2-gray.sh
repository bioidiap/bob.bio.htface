...
#  command_string="./bin/verify.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/resnet-inception-v2-gray--casia.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/cuhk-cufsf/$split "
...
#  command_string+=" --algorithm distance-cosine"
#  command_string+=" -vvv "
...
do
  ...
  command_string="./bin/verify.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/resnet-inception-v2-gray--casia.py ./src/bob.bio.htface/bob/bio/htface/config/experiments/cuhk-cufsf/split1.py "
