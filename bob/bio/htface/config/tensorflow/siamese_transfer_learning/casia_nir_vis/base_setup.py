...
input_data_dir = "/idiap/temp/tpereira/HTFace/CBSR_NIR_VIS_2/idiap_inception_v2_gray--casia/split1/preprocessed/"
input_extension = ".hdf5"

from bob.db.cbsr_nir_vis_2.query import Database
