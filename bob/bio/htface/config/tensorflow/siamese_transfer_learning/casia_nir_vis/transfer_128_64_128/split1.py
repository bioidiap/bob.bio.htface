...
model_dir = "/idiap/temp/tpereira/casia_webface/casia-nir-vis/siamese-transfer-128-64-128-idiap_inception_v2_gray--casia/split1"
protocol = "view2_1"

# Calling our base setup
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.casia_nir_vis.base_setup import *
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.casia_nir_vis.transfer_128_64_128.base_setup import *
...
assert isinstance(database, bob.db.cbsr_nir_vis_2.Database)
