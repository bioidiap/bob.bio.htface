...
./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/transfer-128-64-64-128/split1.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/transfer-128-64-128/split2.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/transfer-128-64-128/split3.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/transfer-128-64-128/split4.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/transfer-128-64-128/split5.py
