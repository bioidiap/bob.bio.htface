...
./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/regular_transfer/split1.py
...
# ./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/regular_transfer/split2.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/regular_transfer/split3.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/regular_transfer/split4.py
...
#./bin/bob_tf_train_generic ./src/bob.bio.htface/bob/bio/htface/config/tensorflow/siamese_transfer_learning/cuhk_cufs/regular_transfer/split5.py
