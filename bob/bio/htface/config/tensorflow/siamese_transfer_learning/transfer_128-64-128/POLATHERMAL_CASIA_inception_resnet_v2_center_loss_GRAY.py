...
model_dir = "/idiap/temp/tpereira/casia_webface/polathermal/resnet_gray_siamese_transfer_128-64-128/"
...
def build_transfer_graph(inputs, reuse=False, mode=tf.estimator.ModeKeys.TRAIN, trainable_variables=False):

    prelogits, _ = inception_resnet_v2(inputs, reuse=reuse, mode=mode, trainable_variables=trainable_variables)
    prelogits, end_points = transfer_graph(prelogits, reuse=reuse)
...
estimator = Siamese(model_dir=model_dir,
                    architecture=build_transfer_graph,
