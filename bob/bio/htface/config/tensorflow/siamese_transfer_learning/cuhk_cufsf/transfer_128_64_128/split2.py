...
model_dir = "/idiap/temp/tpereira/casia_webface/cuhk_cufsf/siamese-transfer-128-64-128-idiap_inception_v2_gray--casia/split2"
protocol = "search_split2_p2s"

# Calling our base setup
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.cuhk_cufsf.base_setup import *
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.cuhk_cufsf.transfer_128_64_128.base_setup import *
...
assert isinstance(database, bob.db.cuhk_cufsf.Database)
