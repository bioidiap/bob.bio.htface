...
model_dir = "/idiap/temp/tpereira/casia_webface/polathermal/siamese-transfer-128-64-128-idiap_inception_v2_gray--casia/split4"
protocol = "VIS-polarimetric-overall-split4"

# Calling our base setup
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.polathermal.base_setup import *
from bob.bio.htface.config.tensorflow.siamese_transfer_learning.polathermal.transfer_128_64_128.base_setup import *
...
assert isinstance(database, bob.db.pola_thermal.Database)
