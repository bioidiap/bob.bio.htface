...
from bob.learn.tensorflow.network import Embedding, inception_resnet_v2
...
checkpoint_filename = "/idiap/temp/tpereira/casia_webface/official_checkpoints/resnet_inception_v2_gray/model_snapshot707500.ckp-707500.meta"
...
def create_network():
    ...
    graph['left'] = inception_resnet_v2(input_left, reuse=False)[0]
    graph['right'] = inception_resnet_v2(input_right, reuse=True)[0]
