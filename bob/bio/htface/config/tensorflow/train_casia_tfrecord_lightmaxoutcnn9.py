...
from bob.learn.tensorflow.network import Embedding, LightCNN9, LightCNN29
...
directory = "/idiap/temp/tpereira/casia_webface/lightcnn_9_maxout_correct"
...
def create_network():
    ...
    network = LightCNN29(n_classes=10575)
