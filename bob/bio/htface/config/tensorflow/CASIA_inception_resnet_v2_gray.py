import numpy
import sys
from bob.learn.tensorflow.datashuffler import TFRecordImage
...
def build_graph(inputs, get_embeddings=False, reuse=False, final_size=160):
    ...
    if get_embeddings:
        ...
        return logits_prelogits['logits']
...
train_graph = build_graph(train_data_shuffler("data", from_queue=False), final_size=final_size)
