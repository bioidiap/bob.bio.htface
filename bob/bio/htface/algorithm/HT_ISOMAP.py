...
class HT_ISOMAP (Algorithm):
  """Tool for computing ISOMAP shift"""
  ...
  def train_projector(self, training_features, projector_file):
    ...
    utils.info("  -> Training ISOMAP reducing to dimension {0} and using {1} components for the reconstruction".format(self.m_subspace_dim, self.m_n_neighbors))

    self.m_machine = sklearn.manifold.Isomap(n_neighbors=self.m_n_neighbors, n_components=self.m_subspace_dim)
