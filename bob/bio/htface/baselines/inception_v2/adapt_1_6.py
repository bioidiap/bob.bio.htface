...
# Siamese
import bob.bio.htface.configs.domain_specific_units.siamese_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_batch_norm
import bob.bio.htface.configs.domain_specific_units.siamese_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_betas_batch_norm

# TRiplet
import bob.bio.htface.configs.domain_specific_units.triplet_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_batch_norm
import bob.bio.htface.configs.domain_specific_units.triplet_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_betas_batch_norm
...
class SiameseAdaptLayers1_6_BatchNorm(Baseline):
    ...
    def __init__(self, **kwargs):
        ...
        name              = "siamese_inceptionv2_adapt_1_6_nonshared_batch_norm"
        extractor         =  pkg_resources.resource_filename("bob.bio.htface", "configs/domain_specific_units/siamese_transfer_learning/inception_resnet_v2_adapt_layers_1_6/extractor_nonshared_batch_norm.py")
        ...
        # train cnn
        self.estimator         = bob.bio.htface.configs.domain_specific_units.siamese_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_batch_norm.get_estimator
...
class SiameseAdaptLayers1_6_BetasBatchNorm(Baseline):
    ...
    def __init__(self, **kwargs):
        ...
        # train cnn
        self.estimator         = bob.bio.htface.configs.domain_specific_units.siamese_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_betas_batch_norm.get_estimator
        self.preprocessed_data = pkg_resources.resource_filename("bob.bio.htface", "configs/tensorflow/siamese_transfer_learning/inception_resnet_v2_databases/")
...
class TripletAdaptLayers1_6_BatchNorm(Baseline):
    ...
    def __init__(self, **kwargs):
        ...
        # train cnn
        self.estimator         = bob.bio.htface.configs.domain_specific_units.triplet_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_batch_norm.get_estimator
        self.preprocessed_data = pkg_resources.resource_filename("bob.bio.htface", "configs/tensorflow/siamese_transfer_learning/inception_resnet_v2_databases/")
...
class TripletAdaptLayers1_6_BetasBatchNorm(Baseline):
    ...
    def __init__(self, **kwargs):
        ...
        # train cnn
        self.estimator         = bob.bio.htface.configs.domain_specific_units.triplet_transfer_learning.inception_resnet_v2_adapt_layers_1_6.estimator_nonshared_betas_batch_norm.get_estimator
        self.preprocessed_data = pkg_resources.resource_filename("bob.bio.htface", "configs/tensorflow/siamese_transfer_learning/inception_resnet_v2_databases/")        
