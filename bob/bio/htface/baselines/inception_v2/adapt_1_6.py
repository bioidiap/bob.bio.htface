...
class SiameseAdaptLayers1_6_BetasBatchNorm(Baseline):
    ...
    def __init__(self):
        ...
        self.name              = "siamese_inceptionv2_adapt_1_6_betas_nonshared_batch_norm"
        self.extractor         =  pkg_resources.resource_filename("bob.bio.htface", "configs/experiments/inception_resnet_v2_adapt_layers_1_6/extractor_nonshared_betas_batch_norm.py")
        self.preprocessor      = pkg_resources.resource_filename("bob.bio.htface", "configs/experiments/inception_resnet_v2/preprocessor.py")
        self.reuse_extractor   = False
...
class TripletAdaptLayers1_6_BetasBatchNorm(Baseline):
    ...
    def __init__(self):
        super(TripletAdaptLayers1_6_BetasBatchNorm, self).__init__()    
    
        self.baseline_type     = "Triplet BN adapt betas"
        self.name              = "triplet_inceptionv2_layers_1_6_betas_nonshared_batch_norm"
        self.extractor         = pkg_resources.resource_filename("bob.bio.htface", "configs/experiments/inception_resnet_v2_adapt_layers_1_6/triplet_extractor_nonshared_betas_batch_norm.py")
        self.preprocessor      = pkg_resources.resource_filename("bob.bio.htface", "configs/experiments/inception_resnet_v2/preprocessor.py")
        self.reuse_extractor   = False        
