...
class FileSelector(object):
  ...
  **Parameters:**
  ...
  modality_separator: String that will be use to split data from different image modalities
  ...
  def __init__(
    ...
    self.m_modality_separator = modality_separator
  ...
  def __arrange_by_modality(self, files, directory_type):
    ...
    for f in files:
      ...
      if type(f) is str:
        ...
        if f.f.modality == self.m_modality_separator:
