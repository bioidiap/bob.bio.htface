...
from bob.bio.htface.architectures.inception_v2 import inception_resnet_v2_adapt_layers_1_6_head
...
model_dir = get_cnn_model_name(temp_dir, "inception_resnet_v2_adapt_layers_1_6_nonshared",
