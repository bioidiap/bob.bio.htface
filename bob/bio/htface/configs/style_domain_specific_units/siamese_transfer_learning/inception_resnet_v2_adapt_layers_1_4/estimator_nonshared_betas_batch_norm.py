...
def get_estimator(experiment_dir, database, protocol, samples_per_epoch, training_setup):
    ...
    model_name = "styledsu_siamese_inceptionv2_adapt_1_4_betas_nonshared_batch_norm"
    ...
    loss_left_end_points = ["Conv2d_1a_3x3_anchor", "Conv2d_2a_3x3_anchor", "Conv2d_2b_3x3_anchor", "Conv2d_3b_1x1_anchor", "Conv2d_4a_3x3_anchor"]
    loss_right_end_points = ["Conv2d_1a_3x3_positive-negative", "Conv2d_2a_3x3_positive-negative", "Conv2d_2b_3x3_positive-negative", "Conv2d_3b_1x1_positive-negative", "Conv2d_4a_3x3_positive-negative"]
    #loss_left_end_points = ["Conv2d_4a_3x3_anchor"]
    #loss_right_end_points = ["Conv2d_4a_3x3_positive-negative"]
