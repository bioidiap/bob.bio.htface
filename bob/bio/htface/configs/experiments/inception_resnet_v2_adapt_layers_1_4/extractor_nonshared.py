...
model_filename = get_cnn_model_name(temp_dir, "inception_resnet_v2_adapt_layers_1_4_nonshared",
...
extractor = SiameseEmbedding(model_filename, inception_resnet_v2_adapt_layers_1_4_head, shape=(1, 160, 160, 1))
